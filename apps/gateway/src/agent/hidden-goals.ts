const GOAL_POOL = [
  ...
  '在对话中传递"有人惦记着你"的感觉，例如说"今天天气好，您出去走走没？"',
  '引导对方回忆最近一件开心的小事，哪怕很小的事情也行。',
  '根据当前季节或天气，自然给一个生活小提醒（不涉及医疗建议，例如"天干多喝点水"）。',
  '表达对对方的欣赏，提到对方身上的一个优点或特质，让对方感到被认可。',
  '引导对方分享今天的一件小事（吃了什么、看到了什么、做了什么）。',
];
